...
export const caretDownEmptyThinIcon = {
  name: 'ui-components:caret-down-empty-thin',
  svgstr: caretDownEmptyThinSvg
};
export const caretDownEmptyIcon = {
  name: 'ui-components:caret-down-empty',
  svgstr: caretDownEmptySvg
};
...
export const caretRightIcon = {
  ...
  svgstr: caretRightSvg
};
export const caretUpEmptyThinIcon = {
  name: 'ui-components:caret-up-empty-thin',
  svgstr: caretUpEmptyThinSvg
};
...
export const fileIcon = { name: 'ui-components:file', svgstr: fileSvg };
export const folderIcon = { name: 'ui-components:folder', svgstr: folderSvg };
export const html5Icon = { name: 'ui-components:html5', svgstr: html5Svg };
export const imageIcon = { name: 'ui-components:image', svgstr: imageSvg };
export const inspectorIcon = {
  name: 'ui-components:inspector',
  svgstr: inspectorSvg
};
export const jsonIcon = { name: 'ui-components:json', svgstr: jsonSvg };
...
export const pythonIcon = { name: 'ui-components:python', svgstr: pythonSvg };
export const rKernelIcon = {
  name: 'ui-components:r-kernel',
  svgstr: rKernelSvg
};
export const reactIcon = { name: 'ui-components:react', svgstr: reactSvg };
...
export const spreadsheetIcon = {
  ...
  svgstr: spreadsheetSvg
};
export const textEditorIcon = {
  name: 'ui-components:text-editor',
  svgstr: textEditorSvg
};
export const vegaIcon = { name: 'ui-components:vega', svgstr: vegaSvg };
export const yamlIcon = { name: 'ui-components:yaml', svgstr: yamlSvg };
export const jupyterFaviconIcon = {
  name: 'ui-components:jupyter-favicon',
  svgstr: jupyterFaviconSvg
};
export const jupyterIcon = {
  name: 'ui-components:jupyter',
  svgstr: jupyterSvg
};
export const jupyterlabWordmarkIcon = {
  name: 'ui-components:jupyterlab-wordmark',
  svgstr: jupyterlabWordmarkSvg
};
export const caseSensitiveIcon = {
  name: 'ui-components:case-sensitive',
  svgstr: caseSensitiveSvg
};
export const regexIcon = { name: 'ui-components:regex', svgstr: regexSvg };
export const buildIcon = { name: 'ui-components:build', svgstr: buildSvg };
...
export const tabIcon = { name: 'ui-components:tab', svgstr: tabSvg };
export const kernelIcon = { name: 'ui-components:kernel', svgstr: kernelSvg };
export const lineFormIcon = {
  name: 'ui-components:line-form',
  svgstr: lineFormSvg
};
export const listIcon = { name: 'ui-components:list', svgstr: listSvg };
export const notTrustedIcon = {
  name: 'ui-components:not-trusted',
  svgstr: notTrustedSvg
};
...
export const addIcon = { name: 'ui-components:add', svgstr: addSvg };
export const bugIcon = { name: 'ui-components:bug', svgstr: bugSvg };
export const checkIcon = { name: 'ui-components:check', svgstr: checkSvg };
export const circleEmptyIcon = {
  name: 'ui-components:circle-empty',
  svgstr: circleEmptySvg
};
export const circleIcon = { name: 'ui-components:circle', svgstr: circleSvg };
export const closeIcon = { name: 'ui-components:close', svgstr: closeSvg };
export const copyIcon = { name: 'ui-components:copy', svgstr: copySvg };
export const cutIcon = { name: 'ui-components:cut', svgstr: cutSvg };
export const downloadIcon = {
  name: 'ui-components:download',
  svgstr: downloadSvg
};
export const editIcon = { name: 'ui-components:edit', svgstr: editSvg };
...
export const fileUploadIcon = {
  ...
  svgstr: fileUploadSvg
};
export const filterListIcon = {
  name: 'ui-components:filter-list',
  svgstr: filterListSvg
};
export const linkIcon = { name: 'ui-components:link', svgstr: linkSvg };
export const newFolderIcon = {
  name: 'ui-components:new-folder',
  svgstr: newFolderSvg
};
export const pasteIcon = { name: 'ui-components:paste', svgstr: pasteSvg };
export const refreshIcon = {
  name: 'ui-components:refresh',
  svgstr: refreshSvg
};
export const runIcon = { name: 'ui-components:run', svgstr: runSvg };
export const saveIcon = { name: 'ui-components:save', svgstr: saveSvg };
export const searchIcon = { name: 'ui-components:search', svgstr: searchSvg };
export const stopIcon = { name: 'ui-components:stop', svgstr: stopSvg };
export const undoIcon = { name: 'ui-components:undo', svgstr: undoSvg };
